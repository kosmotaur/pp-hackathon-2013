...
module.exports = function(grunt) {
  ...
  // TODO JSHinting of transpiled coffeescript to catch any `console`/`debugger`/development specific code
  ...
  // ATTENTION YOU NEED YOUR SSH KEYS
  // SET UP ON THE SERVER YOU'RE DEPLOYING
  // TO IF YOU WANT THIS TO WORK
  // GRUNT DOESN'T SUPPORT PROMPTS
